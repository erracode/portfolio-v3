...
>(({ className, "aria-label": ariaLabel, ...props }, ref) => (
  <div className={cn("relative w-full", className)}>
    {/* Radix puts consumer props like `id`/`aria-label` on this Root
        wrapper, not on the actual focusable Thumb — forward `aria-label`
        to the Thumb explicitly so it lands on the element that carries
        `role="slider"`. */}
