...
export interface BitDropownMenuSubContentProps
  extends React.ComponentProps<typeof ShadcnDropdownMenuSubContent>,
...
function DropdownMenuContent({
  ...
  return (
    <ShadcnDropdownMenuContent
      ...
      {...props}
    >
      <div className="max-h-(--radix-dropdown-menu-content-available-height) overflow-x-hidden overflow-y-auto">
        {children}
      </div>
